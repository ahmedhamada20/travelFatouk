    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h4 class="page-title m-0">Show car</h4>
                </div>
                <!-- end col -->
            </div>
            <!-- end row -->
...
<div class="row">
    <div class="col">
        <div class="card">
            <div class="card-body">
                <h4 class="mt-0 header-title">Show car :: {{$data->name}}</h4>
                ...
                <div class="tab-content">
                    <div class="tab-pane active p-3" id="home-1" role="tabpanel">
                        ...
                        <div class="row">
                            <div class="col">
                                <label>Price</label>
                                <input type="number" name="price_adult_EG" value="{{$data->price}}"
                    ...
                    <div class="tab-pane p-3" id="profile-1" role="tabpanel">
                        ...
                        <form action="{{route('car.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="input-group mb-3">
                                <input type="file" class="form-control" accept="image/*" name="FilenameMany[]" multiple
                                    required>
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive nowrap text-center"
                            ...
                            <tbody>
                                @foreach(getphotosCar($data->id) as $row)
                                <tr>
                                    <td>{{$loop->iteration}}</td>
                                    <td>
                                        <a href="{{asset('admin/pictures/car/' . $data->id . '/' . $row->Filename)}}"
                                            target="_blank"> <img
                                                src="{{asset('admin/pictures/car/' . $data->id . '/' . $row->Filename)}}"
