...
@section('content')
        ...
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h4 class="page-title m-0">Edit car :: {{$data->name}}</h4>
                    </div>
                    <!-- end col -->
                </div>
                <!-- end row -->
    ...
    <div class="row">
        <div class="col">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('car.update','test')}}" method="post" enctype="multipart/form-data">
                       @method('PUT')
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <label>priceback</label>
                                <input type="number" name="price_back" value="{{$data->price_back}}"
                            ...
                            <div class="col">
                                ...
                                <input type="text" name="car_type" value="{{ $data->car_type }}"
                                       class="form-control @error('car_type') is-invalid @enderror">
                            </div>
                            <div class="col">
                                <label>car model</label>
                                <input type="text" name="car_model" value="{{ $data->car_model }}"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea class="form-control" rows="5" name="conslshen" id="elm1">
                                  {{$data->getTranslation('conslshen','ar')}}
                                </textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea class="form-control" rows="5" name="conslshen_en" id="elm1">
                                    {{$data->getTranslation('conslshen','en')}}
                                </textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea class="form-control" rows="5" name="conslshen_de" id="elm1">
                                    {{$data->getTranslation('conslshen','de')}}
                                </textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea class="form-control" rows="5" name="conslshen_it" id="elm1">
                                    {{$data->getTranslation('conslshen','it')}}
                                </textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea class="form-control" rows="5" name="conslshen_ru" id="elm1">
                                    {{$data->getTranslation('conslshen','ru')}}
                                </textarea>
                            </div>
                        </div>
