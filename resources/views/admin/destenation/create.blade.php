                    ...
                    <form action="{{route('destenation.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea class="form-control" name="note" rows="5" id="elm1"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea class="form-control" name="note_en" rows="5" id="elm1"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea class="form-control" name="note_de" rows="5" id="elm1"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea class="form-control" name="note_it" rows="5" id="elm1"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea class="form-control" name="note_ru" rows="5" id="elm1"></textarea>
                            </div>
                        </div>
