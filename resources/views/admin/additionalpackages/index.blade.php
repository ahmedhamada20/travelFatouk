        ...
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h4 class="page-title m-0">additional</h4>
                    </div>
                    <!-- end col -->
                </div>
                <!-- end row -->
        ...
        <div class="col-12">
            <div class="card m-b-30">
                <div class="card-header">
                    ...
                    @include('admin.additionalpackages.create')             
                   </div>
                <div class="card-body">
                    <table id="datatable" class="table table-bordered dt-responsive nowrap text-center"
                        ...
                        @foreach($data as $row)
                            <tr>
                                ...
                                @include('admin.additionalpackages.edit')
                                @include('admin.additionalpackages.deleted')
                            </tr>
                            <!-- Modal -->
                        @endforeach
                        </tbody>
