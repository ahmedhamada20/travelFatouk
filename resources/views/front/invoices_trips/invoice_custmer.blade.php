                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered mb-0">
                                ...
                                <tr>
                                    ...
                                    <th class="text-uppercase small font-weight-bold">Price trips</th>
                                ...
                                @auth
                                    @if (auth()->user()->countries_id == 173)
                                        <tr>
                                            <td>1</td>
                                            <td>{{  $newCart_cutsmer->trip->name }}</td>
                                            <td>{{  $newCart_cutsmer->trip->price_adult_EG }}</td>
                                            <td>{{ (int) \Gloudemans\Shoppingcart\Facades\Cart::subtotal()}}</td>
                                            <td>{{ (int) \Gloudemans\Shoppingcart\Facades\Cart::subtotal() +  $newCart_cutsmer->total }}</td>
                                    ...
                                    @else
                                        <tr>
                                            <td>1</td>
                                            <td>{{  $newCart_cutsmer->trip->name  }}</td>
                                            <td>{{ $newCart_cutsmer->trip->price_adult_EN  }}</td>
                                            <td>{{ (int) \Gloudemans\Shoppingcart\Facades\Cart::subtotal()}}</td>
                                            <td>{{ (int) \Gloudemans\Shoppingcart\Facades\Cart::subtotal() +  $newCart_cutsmer->total}}</td>
